...
if not os.getenv('IS_TRAVIS', False):
    from cshsms.settings_secret import SECRET_KEY, DATABASES, REMOTE, TEXTLOCAL_API, TEXTLOCAL_PRIMARY_ID, HSPSMS_API
else:
    from cshsms.settings_travis import SECRET_KEY, DATABASES, REMOTE, TEXTLOCAL_API, TEXTLOCAL_PRIMARY_ID, HSPSMS_API
