...
class TextProcessorProcessTests(TestCase):
    ...
    def test_subscribe_twice_english(self, texting_mock, logging_info_mock, logging_error_mock):
        ...
        self.assertTrue(t.contacts.exists())
        second_response = t.process("JOIN ROSE 25-11-2012")
    ...
    def test_subscribe_twice_hindi(self, texting_mock, logging_info_mock, logging_error_mock):
        ...
        self.assertTrue(t.contacts.exists())
        second_response = t.process(hindi_remind() + " SANJIV 25-11-2012")
    ...
    # TODO: Subscribe and then cancel
    # TODO: Subscribe and then cancel and then subscribe
