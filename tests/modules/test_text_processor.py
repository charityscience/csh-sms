...
class TextProcessorProcessTests(TestCase):
    ...
    def test_subscribe(self, texting_mock, logging_mock):
        ...
        join_message = t.write_to_database(message="JOIN PAULA 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_hindi_join(self, texting_mock, logging_mock):
        ...
        self.assertFalse(t.get_contacts().exists())
        message = t.write_to_database(message=hindi_remind() + " Sai 11/09/2013",
                                        date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_hindi_join_with_hindi_name(self, texting_mock, logging_mock):
        ...
        self.assertFalse(t.get_contacts().exists())
        message_object = t.write_to_database(message=message, date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_process_with_placeholder_child_english(self, texting_mock, logging_mock):
        ...
        self.assertFalse(t.get_contacts().exists())
        message_object = t.write_to_database(message="JOIN 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(message_object)
    ...
    def test_process_with_placeholder_child_hindi(self, texting_mock, logging_mock):
        ...
        self.assertFalse(t.get_contacts().exists())
        message_object = t.write_to_database(message=hindi_remind() + " 25-11-2012",
                                                date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(message_object)
    ...
    def test_subscribe_with_too_long_name(self, texting_mock, logging_mock):
        ...
        long_name_join = t.write_to_database(message="JOIN " + long_name + " 25-11-2012",
                                                date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_unsubscribe_english(self, texting_mock, logging_mock):
        ...
        join_message = t.write_to_database(message="JOIN Roland 12/11/2017",
                                            date=datetime(2017, 8, 9, 0, 5, 10).replace(tzinfo=timezone.get_default_timezone()))
        t.process(join_message)
        end_message = t.write_to_database(message="END", date=datetime(2017, 8, 10, 0, 5, 10).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_unsubscribe_hindi(self, texting_mock, logging_mock):
        ...
        t = TextProcessor(phone_number="1-112-1112")
        end_message = t.write_to_database(message="END", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(end_message)
        self.assertTrue(t.get_contacts().first().cancelled)
    ...
    def test_subscribe_twice_english(self, texting_mock, logging_info_mock, logging_error_mock):
        ...
        join_message = t.write_to_database(message="JOIN ROSE 25-11-2012",
                                            date=datetime(2016, 10, 30, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        ...
        second_join = t2.write_to_database(message="JOIN ROSE 25-11-2012",
                                            date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_subscribe_twice_hindi(self, texting_mock, logging_info_mock, logging_error_mock):
        ...
        join_message = t.write_to_database(message=hindi_remind() + " SANJIV 25-11-2012",
                                            date=datetime(2016, 10, 30, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        first_response = t.process(join_message)
        ...
        self.assertTrue(t2.get_contacts().exists())
        second_join = t.write_to_database(message=hindi_remind() + " SANJIV 25-11-2012",
                                            date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        second_response = t2.process(second_join)
    ...
    def test_text_in_pregnancy_birthdate_update_english(self, texting_mock):
        t = TextProcessor(phone_number="1-111-1114")
        self.assertFalse(Contact.objects.filter(name="Rose", phone_number="1-111-1114").exists())
        join_message = t.write_to_database(message="JOIN ROSE 25-10-2012",
                                            date=datetime(2016, 10, 30, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        first_response = t.process(join_message)
        self.assertEqual(first_response, msg_subscribe("English").format(name="Rose"))
        texting_mock.assert_called_with(message=first_response, phone_number="1-111-1114")
        ...
        self.assertTrue(t.get_contacts().exists())
        t2 = TextProcessor(phone_number="1-111-1114")
        born_update = t2.write_to_database(message="BORN ROSE 25-11-2012",
                                            date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_existing_contact_pregnancy_birthdate_update_english(self, texting_mock):
        ...
        born_update = t3.write_to_database(message="BORN Tina 25-07-2017",
                                            date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_text_in_pregnancy_birthdate_update_hindi(self, texting_mock):
        ...
        join_message = t.write_to_database(message=hindi_remind() + " Sanjiv 25-10-2012",
                                            date=datetime(2016, 10, 30, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        first_response = t.process(join_message)
        self.assertEqual(first_response, msg_subscribe("Hindi").format(name="Sanjiv"))
        texting_mock.assert_called_with(message=first_response, phone_number="1-111-1114")
        ...
        self.assertTrue(t.get_contacts().exists())
        t2 = TextProcessor(phone_number="1-111-1114")
        born_update = t2.write_to_database(message=hindi_born() + " Sanjiv 25-11-2012",
                                            date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        second_response = t2.process(born_update)
        self.assertTrue(t2.get_contacts().exists())
    ...
    def test_preg_updates_with_opposite_language_keep_original_language_hindi(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        join_message = t.write_to_database(message=hindi_remind() + " Aarav 25-11-2012",
                                            date=datetime(2016, 10, 30, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(join_message)
        ...
        born_message = t.write_to_database(message="BORN Aarav 25-11-2012",
                                            date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_subscribe_two_children(self, texting_mock, logging_info_mock, logging_error_mock):
        ...
        peter_join = t.write_to_database(message="JOIN PETER 11-12-2016",
                                        date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        ...
        ben_join = t2.write_to_database(message="JOIN BEN 4-10-2016",
                                        date=datetime(2016, 10, 31, 10, 10, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_subscribe_then_cancel(self, texting_mock, logging_mock):
        ...
        sub_message = t.write_to_database(message="JOIN ROB 25-11-2012",
                                            date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        ...
        end_message = t.write_to_database(message="END",
                                            date=datetime(2016, 11, 28, 10, 5, 5, 10).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_subscribe_then_cancel_then_subscribe(self, texting_mock, logging_mock):
        ...
        join_message = t.write_to_database(message="JOIN CHEYENNE 25-11-2012",
                                            date=datetime(2016, 10, 29, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        t.process(join_message)
        contacts = Contact.objects.filter(name="Cheyenne", phone_number="1-111-1117")
        self.assertTrue(contacts.exists())
        self.assertFalse(contacts.first().cancelled)
        t2 = TextProcessor(phone_number="1-111-1117")
        end_message = t2.write_to_database(message="END",
                                            date=datetime(2016, 10, 30, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        t2.process(end_message)
        contacts = Contact.objects.filter(name="Cheyenne", phone_number="1-111-1117")
        self.assertTrue(contacts.exists())
        ...
        join_again_message = t3.write_to_database(message="JOIN CHEYENNE 25-11-2012",
                                                    date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_subscribe_then_cancel_then_update_dob(self, texting_mock, logging_mock):
        ...
        join_again_message = t3.write_to_database(message="JOIN CHEYENNE 25-12-2012",
                                                    date=datetime(2016, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        t3.process(join_again_message)
        contacts = Contact.objects.filter(name="Cheyenne", phone_number="1-111-1118")
        self.assertTrue(contacts.exists())
    ...
    def test_subscribe_then_cancel_then_update_language(self, texting_mock, logging_mock):
        ...
        join_message = t.write_to_database(message="JOIN LARISSA 25-11-2012",
                                            date=datetime(2017, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
        first_response = t.process(join_message)
        ...
        t2.process(end_message)
        t3 = TextProcessor(phone_number="1-111-1118")
        resub_message = t.write_to_database(message=hindi_remind() + " LARISSA 25-11-2012",
                                            date=datetime(2017, 10, 31, 10, 5, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_keyword_failure(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        message_object = t.write_to_database(message="JLORN COACHZ 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(message_object)
        self.assertEqual(response, msg_failure("English"))
    ...
    def test_keyword_failure_hindi(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        message_object = t.write_to_database(message=u'\u0906\u0930 \u0906\u0930\u0935 25-11-2012',
                                                date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(message_object)
    ...
    def test_keyword_failed_date_english(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        message = t.write_to_database(message="JOIN PAULA 25:11:2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(message)
    ...
    def test_keyword_failed_date_hindi(self, texting_mock, logging_mock):
        ...
        message_object = t.write_to_database(message=invalid_text_message, date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(message_object)
    ...
    def test_processing_subscriptions_creates_message_objects(self, texting_mock, logging_mock):
        ...
        hindi_message = t.write_to_database(message=hindi_remind() + u' \u0906\u0930\u0935' + " 30-11-2016",
                                            date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_subscriptions_creates_message_objects_with_no_names(self, texting_mock, logging_mock):
        ...
        no_name_join = t.write_to_database(message="JOIN 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        ...
        hindi_no_name_join = t.write_to_database(message=hindi_remind() + " 30-11-2016",
                                                date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_unsubscriptions_creates_message_objects(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1112")
        join_message = t.write_to_database(message="JOIN Roland 12/11/2017",
                                            date=datetime(2017, 5, 9, 20, 35, 13).replace(tzinfo=timezone.get_default_timezone()))
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number=t.phone_number),
                                                direction="Incoming", body="END"))
        t.process(join_message)
        end_message = t.write_to_database(message="END",
                                            date=datetime(2017, 5, 10, 20, 35, 13).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(end_message)
        self.assertTrue(t.get_contacts().first().cancelled)
        self.assertEqual(response, msg_unsubscribe("English"))
        logging_mock.assert_called_with("Unsubscribing `1-111-1112`...")
        ...
        t = TextProcessor(phone_number="1-111-1113")
        hindi_sub_message = t.write_to_database(message=hindi_remind() + u' \u0906\u0930\u0935' + " 30-11-2016",
                                                date=datetime(2017, 5, 9, 20, 35, 13).replace(tzinfo=timezone.get_default_timezone()))
        t.process(hindi_sub_message)
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number=t.phone_number),
                                                direction="Incoming", body="END"))
        hindi_end = t.write_to_database(message="END", date=datetime(2017, 5, 10, 20, 35, 13).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_failure_messages_creates_message_objects(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        self.assertFalse(Contact.objects.filter(phone_number=t.phone_number).exists())
        fail_message = t.write_to_database(message="JLORN COACHZ 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        ...
        hindi_fail_message = t2.write_to_database(message=u'\u0906\u0930 \u0906\u0930\u0935 25-11-2012',
                                                    date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_pregnancy_updates_creates_message_objects(self, texting_mock):
        ...
        self.assertTrue(t.get_contacts().exists())
        self.assertTrue(Contact.objects.filter(name="Tina", phone_number="910003456789", language_preference="English", date_of_birth=datetime(2017, 7, 10, 0, 0), preg_signup=True, preg_update=False).exists())
        born_message = t.write_to_database(message="BORN Tina 25-07-2017", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        ...
        self.assertTrue(t2.get_contacts().exists())
        self.assertTrue(Contact.objects.filter(name="Sanjiv", phone_number="910003456789", language_preference="Hindi", date_of_birth=datetime(2017, 7, 10, 0, 0), preg_signup=True, preg_update=False).exists())
        hin_born_message = t2.write_to_database(message=hindi_born() + " Sanjiv 25-07-2017", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_creates_correct_amount_of_message_objects(self, texting_mock, logging_mock):
        ...
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number=t.phone_number),
                                                direction="Incoming", body="JOIN PAULA 25-11-2012"))
        message_object = t.write_to_database(message="JOIN PAULA 25-11-2012", date=datetime(2017, 4, 2, 0, 0, 0).replace(tzinfo=timezone.get_default_timezone()))
        self.assertTrue(Contact.objects.filter(name="Paula", phone_number="1-111-1111").exists())
        ...
        second_message = t2.write_to_database(message="JOIN SMITH 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        t2.process(second_message)
        t3 = TextProcessor(phone_number="1-113-1111")
        third_message = t3.write_to_database(message="JOIN Aaja 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        t3.process(third_message)
        t4 = TextProcessor(phone_number="1-114-1111")
        fourth_message = t4.write_to_database(message="JOIN Lauren 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        t4.process(fourth_message)
        t_end_message = t.write_to_database(message="END", date=datetime(2017, 4, 3, 0, 0, 0).replace(tzinfo=timezone.get_default_timezone()))
        ...
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number=t.phone_number),
                                                direction="Incoming", body=hindi_remind() + u' \u0906\u0930\u0935' + " 30-11-2016"))
        t5_message = t5.write_to_database(message=hindi_remind() + u' \u0906\u0930\u0935' + " 30-11-2016",
                                            date=datetime(2017, 4, 2, 0, 0, 0).replace(tzinfo=timezone.get_default_timezone()))
        ...
        t6_message = t6.write_to_database(message=hindi_information() + " SMITH 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        t6.process(t6_message)
        t7 = TextProcessor(phone_number="1-111-1117")
        t7_message = t7.write_to_database(message=hindi_information() + " Aaja 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        t7.process(t7_message)
        t8 = TextProcessor(phone_number="1-111-1118")
        t8_message = t8.write_to_database(message=hindi_information() + " Lauren 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        t8.process(t8_message)
        t5_end_message = t5.write_to_database(message="END", date=datetime(2017, 4, 3, 0, 0, 0).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_updates_contact_last_heard_from_english(self, logging_error):
        ...
        fail_message = t2.write_to_database(message="Stuff", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        ...
        born_message = t3.write_to_database(message="BORN PAULA 25-11-2012", date=datetime(2018, 1, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        stop_message = t3.write_to_database(message="STOP", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        rejoin_message = t.write_to_database(message="JOIN PAULA 25-11-2012", date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_updates_contact_last_heard_from_during_unsub(self, logging_error):
        t = TextProcessor(phone_number="1-111-1111")
        join_message = t.write_to_database(message="JOIN PAULA 25-11-2012", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        t.process(join_message)
        original_contact = Contact.objects.filter(name="Paula", phone_number="1-111-1111").first()

        end_message = t.write_to_database(message="END", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        second_join_message = t2.write_to_database(message="JOIN Namey 25-11-2014", date=datetime(2018, 1, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        second_end_message = t3.write_to_database(message="END", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_updates_contact_last_heard_from_hindi(self, texting_mock, logging_mock):
        ...
        join_message = t.write_to_database(message=hindi_remind() + " Aarav 25-11-2012", date=datetime(2017, 9, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(join_message)
        original_contact = Contact.objects.filter(name="Aarav", phone_number="1-111-1111").first()
        logging_mock.assert_called_with("Subscribing " + quote(join_message.body) + "...")
        texting_mock.assert_called_once_with(message=response, phone_number="1-111-1111")

        born_message = t.write_to_database(message="BORN Aarav 25-11-2012", date=datetime(2018, 1, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        born_response = t.process(born_message)
        texting_mock.assert_called_with(message=born_response, phone_number="1-111-1111")
    ...
    def test_processing_updates_contact_last_heard_from_for_failures(self, logging_error_mock):
        t = TextProcessor(phone_number="1-111-1111")
        join_message = t.write_to_database(message="JOIN PAULA 25-11-2012", date=datetime(2018, 2, 14, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(join_message)
        original_contact = Contact.objects.filter(name="Paula", phone_number="1-111-1111").first()
        
        fail_message = t.write_to_database(message="Nonsense", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        hin_join_message = t2.write_to_database(message=hindi_remind() + " Aarav 25-11-2012", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t2.process(hin_join_message)
        hin_original_contact = Contact.objects.filter(name="Aarav", phone_number="1-111-3333").first()
        
        hin_fail_message = t2.write_to_database(message=u"\u0926\u093f\u0928", date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_updates_contact_last_contacted_english(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        join_message = t.write_to_database(message="JOIN PAULA 25-11-2012", date=datetime(2018, 2, 13, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(join_message)
        original_contact = Contact.objects.filter(name="Paula", phone_number="1-111-1111").first()
        logging_mock.assert_called_with("Subscribing `JOIN PAULA 25-11-2012`...")
        texting_mock.assert_called_once_with(message=response, phone_number="1-111-1111")

        born_update = t.write_to_database(message="BORN PAULA 25-11-2012", date=datetime(2018, 2, 14, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_updates_contact_last_contacted_hindi(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        join_message = t.write_to_database(message=hindi_remind() + " Aarav 25-11-2012",
                                            date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(join_message)
        original_contact = Contact.objects.filter(name="Aarav", phone_number="1-111-1111").first()
        ...
        born_message = t.write_to_database(message="BORN Aarav 25-11-2012",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        born_response = t.process(born_message)
        texting_mock.assert_called_with(message=born_response, phone_number="1-111-1111")
        updated_contact = Contact.objects.filter(name="Aarav", phone_number="1-111-1111").first()
        ...
        end_message = t.write_to_database(message="END",
                                            date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        end_response = t.process(end_message)
        texting_mock.assert_called_with(message=end_response, phone_number="1-111-1111")
        unsub_contact = Contact.objects.filter(name="Aarav", phone_number="1-111-1111").first()
        self.assertNotEqual(original_contact.last_contacted, unsub_contact.last_contacted)
    ...
    def test_processing_updates_contact_last_contacted_for_failures_english(self, logging_error_mock):
        ...
        fail_message = t.write_to_database(message="Nonsense", date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        fail_response = t.process(fail_message)
        fail_contact = Contact.objects.filter(name="Paula", phone_number="1-111-1111").first()
        logging_error_mock.assert_called()
    ...
    def test_processing_updates_contact_last_contacted_for_failures_hindi(self, logging_error_mock):
        t2 = TextProcessor(phone_number="1-111-3333")
        hin_join_message = hindi_remind() + " Aarav 25-11-2012"
        hin_join_message = t2.write_to_database(message=hindi_remind() + " Aarav 25-11-2012",
                                                date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t2.process(hin_join_message)
        hin_original_contact = Contact.objects.filter(name="Aarav", phone_number="1-111-3333").first()
        
        hin_fail_message = t2.write_to_database(message=u"\u0926\u093f\u0928",
                                                date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        hin_fail_response = t2.process(hin_fail_message)
    ...
    def test_processing_makes_contact_last_heard_from_time_message_time(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        join_message = t.write_to_database(message="JOIN PAULA 25-11-2012",
                                            date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(join_message)
        original_contact = Contact.objects.filter(name="Paula", phone_number="1-111-1111").first()
        logging_mock.assert_called_with("Subscribing `JOIN PAULA 25-11-2012`...")
        ...
        born_message = t.write_to_database(message="BORN PAULA 25-11-2012",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        born_response = t.process(born_message)
        texting_mock.assert_called_with(message=born_response, phone_number="1-111-1111")
        ...
        end_message = t.write_to_database(message="END", date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        end_response = t.process(end_message)
        texting_mock.assert_called_with(message=end_response, phone_number="1-111-1111")
    ...
    def test_processing_english_failed_messages_updates_contact_time_references(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        keyword = "SDFDAJFDF"
        fail_message = t.write_to_database(message="SDFDAJFDF PAULA 25-11-2012",
                                            date=datetime(2018, 2, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(fail_message)
        ...
        failed_date_message = t.write_to_database(message="BORN PAULA 60-11-2012",
                                                    date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_hindi_failed_messages_updates_contact_time_references(self, texting_mock, logging_mock):
        t = TextProcessor(phone_number="1-111-1111")
        keyword = u"\u0906\u092a"
        fail_message = t.write_to_database(message=keyword + " Aarav 25-11-2012",
                                            date=FAKE_NOW.replace(tzinfo=timezone.get_default_timezone()))
        response = t.process(fail_message)
        original_contact = Contact.objects.filter(phone_number="1-111-1111").first()
        logging_mock.assert_called_with("Keyword " + quote(keyword.lower()) + " in message " + quote(fail_message.body) +
    ...
    def test_processing_only_updates_contact_time_references_for_correct_contact(self, texting_mock, logging_mock):
        ...
        failed_date = t2.write_to_database(message="BORN PAULA 60-11-2012",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_write_to_database_writes_correct_message(self):
        ...
        t.write_to_database(message="Test message", date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        t2.write_to_database(message="JOIN Marshall 20-10-2017", date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        self.assertEqual(1, Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-2222").first(),
                                                    ...
                                                    direction="Incoming").count())
        t2.write_to_database(message="END", date=datetime(2018, 5, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        self.assertEqual(1, Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-2222").first(),
                                                    body="END",
                                                    direction="Incoming").count())
    ...
    def test_write_to_database_finds_existing_contact_names_english(self):
        t = TextProcessor(phone_number="1-111-1111")
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-1111").first()))
        incoming = t.write_to_database(message="JOIN Marshall 20-10-2017", date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        t.process(incoming)
        contact = Contact.objects.get(phone_number=t.phone_number)
        self.assertEqual("Marshall", contact.name)
        t.write_to_database(message="END", date=datetime(2018, 3, 20, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        t2.write_to_database(message="END", date=datetime(2018, 3, 25, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_write_to_database_finds_existing_contact_names_hindi(self):
        ...
        contact = Contact.objects.get(phone_number=t.phone_number)
        self.assertEqual("Marshall", contact.name)
        t.write_to_database(message="END", date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        contact = Contact.objects.get(phone_number=t.phone_number)
        end_message = Message.objects.get(body="END", direction="Incoming")
        t.process(end_message)
        self.assertEqual(contact.name, end_message.contact.name)
    ...
    def test_write_to_database_assigns_incoming_datetime_as_message_received_at_english(self):
        ...
        t2 = TextProcessor(phone_number="9101234567890")
        self.assertTrue(Contact.objects.get(pk=second_contact.id))
        t2.write_to_database(message="END", date=datetime(2017, 10, 6, 0, 5).replace(tzinfo=timezone.get_default_timezone()))
        second_end_message = Message.objects.get(contact=second_contact, body="END", direction="Incoming")
    ...
    def test_write_to_database_assigns_incoming_datetime_as_message_received_at_for_failures(self, logging_error):
        ...
        self.assertEqual(fail_incoming.received_at, datetime(2017, 6, 8, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        t.write_to_database(message="---ASDFad",
        ...
        self.assertEqual(fail_incoming.received_at, datetime(2017, 6, 8, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        t.write_to_database(message=u"\u0940\u091c\u093f", date=datetime(2017, 6, 6, 0, 5).replace(tzinfo=timezone.get_default_timezone()))
    ...
    @patch("modules.text_processor.Texter.send")
    def test_outgoing_messages_not_assigned_received_at_english(self, texting_mock):
        t = TextProcessor(phone_number="1-111-1111")
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-1111").first()))
        incoming = t.write_to_database(message="JOIN Marshall 20-10-2017", date=datetime(2017, 6, 5, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        incoming_response_body = t.process(incoming)
        incoming_response = Message.objects.filter(direction="Outgoing", body=incoming_response_body).first()
        self.assertIsInstance(incoming_response, Message)
        self.assertIsNone(incoming_response.received_at)
        born = t.write_to_database(message="BORN Marshall 20-10-2017", date=datetime(2017, 6, 8, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        born_response_body = t.process(born)
        born_response = Message.objects.filter(direction="Outgoing", body=incoming_response_body).last()
        self.assertNotEqual(born_response.id, incoming_response.id)
        self.assertIsInstance(born_response, Message)
        self.assertIsNone(born_response.received_at)
        end_message = t.write_to_database(message="END", date=datetime(2017, 6, 6, 0, 5).replace(tzinfo=timezone.get_default_timezone()))
        end_response_body = t.process(end_message)
        end_response = Message.objects.filter(direction="Outgoing", body=end_response_body).first()
        self.assertIsInstance(end_response, Message)
        self.assertIsNone(end_response.received_at)
        self.assertEqual(1, Contact.objects.all().count())

    @patch("modules.text_processor.Texter.send")
    def test_outgoing_messages_not_assigned_received_at_hindi(self, texting_mock):
        t = TextProcessor(phone_number="1-111-1111")
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-1111").first()))
        incoming = t.write_to_database(message=hindi_remind() + " Marshall 20-10-2017", date=datetime(2017, 6, 5, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        incoming_response_body = t.process(incoming)
        incoming_response = Message.objects.filter(direction="Outgoing", body=incoming_response_body).first()
        self.assertIsInstance(incoming_response, Message)
        self.assertIsNone(incoming_response.received_at)
        born = t.write_to_database(message=hindi_born() + " Marshall 20-10-2017", date=datetime(2017, 6, 8, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        born_response_body = t.process(born)
        born_response = Message.objects.filter(direction="Outgoing", body=incoming_response_body).last()
        self.assertNotEqual(born_response.id, incoming_response.id)
        self.assertIsInstance(born_response, Message)
    ...
    @patch("logging.error")
    @patch("modules.text_processor.Texter.send")
    def test_outgoing_messages_not_assigned_received_at_for_failures(self, texting_mock, logging_error):
        t = TextProcessor(phone_number="1-111-1111")
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-1111").first()))
        incoming = t.write_to_database(message="JOIN Marshall 20-10-2017",
                                        date=datetime(2017, 6, 5, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        ...
        fail_incoming = t.write_to_database(message="NOT READABLE",
                                        date=datetime(2017, 6, 8, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        fail_incoming_response_body = t.process(fail_incoming)
        fail_incoming_response = Message.objects.filter(direction="Outgoing", body=fail_incoming_response_body).last()
        self.assertIsInstance(fail_incoming_response, Message)
        self.assertIsNone(fail_incoming_response.received_at)
        fail_two = t.write_to_database(message="---ASDFad",
                            date=datetime(2017, 6, 6, 0, 5).replace(tzinfo=timezone.get_default_timezone()))
        fail_two_response_body = t.process(fail_two)
        fail_two_response = Message.objects.filter(direction="Outgoing", body=fail_two_response_body).last()
        self.assertIsInstance(fail_two_response, Message)
        self.assertNotEqual(fail_incoming_response.id, fail_two_response.id)
        self.assertIsNone(fail_two_response.received_at)
        
        empty_fail = t.write_to_database(message=" ",
                            date=datetime(2017, 6, 6, 0, 45).replace(tzinfo=timezone.get_default_timezone()))
        empty_fail_response_body = t.process(empty_fail)
        empty_fail_response = Message.objects.filter(direction="Outgoing", body=empty_fail_response_body).last()
        self.assertIsInstance(empty_fail_response, Message)
        self.assertNotEqual(fail_incoming_response.id, empty_fail_response.id)
        self.assertNotEqual(fail_two_response.id, empty_fail_response.id)
        self.assertIsNone(empty_fail_response.received_at)
        self.assertEqual(1, Contact.objects.all().count())
        ...
        fail_incoming = t2.write_to_database(message=u"\u0936\u093f\u0936",
                                            date=datetime(2017, 6, 8, 10, 15).replace(tzinfo=timezone.get_default_timezone()))
        fail_incoming_response_body = t2.process(fail_incoming)
        fail_incoming_response = Message.objects.filter(direction="Outgoing", body=fail_incoming_response_body).first()
        self.assertIsInstance(fail_incoming_response, Message)
        self.assertIsNone(fail_incoming_response.received_at)
        fail_two = t.write_to_database(message=u"\u0940\u091c\u093f", date=datetime(2017, 6, 6, 0, 5).replace(tzinfo=timezone.get_default_timezone()))
        fail_two_response_body = t2.process(fail_two)
        fail_two_response = Message.objects.filter(direction="Outgoing", body=fail_two_response_body).last()
        self.assertIsInstance(fail_two_response, Message)
        self.assertNotEqual(fail_two_response.id, fail_incoming.id)
        self.assertIsNone(fail_two_response.received_at)
        self.assertEqual(2, Contact.objects.all().count())
    ...
    def test_processing_updates_message_is_processed_hindi(self):
        t2 = TextProcessor(phone_number="1-111-1111")
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-1111").first()))
        hindi_join = t2.write_to_database(message=hindi_remind() + " Marshall 20-10-2017",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        hindi_end_message = t2.write_to_database(message="END",
                                                    date=datetime(2018, 7, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_updates_message_is_processed_english(self):
        t2 = TextProcessor(phone_number="1-111-2222")
        self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-2222").first()))
        eng_join = t2.write_to_database(message="JOIN Marshall 20-10-2017",
                                        date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        outgoing = Message.objects.filter(contact=contact, direction="Outgoing").first()
        self.assertTrue(outgoing.is_processed)
        eng_end_message = t2.write_to_database(message="END",
                                                date=datetime(2018, 3, 25, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_assigns_message_sent_at_to_now_english(self, texting_mock):
        with freeze_time(datetime(2017, 7, 17, 0, 0)):
            ...
            eng_born_message = t2.write_to_database(message="BORN Marshall 20-10-2017",
                                                    date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
            ...
            eng_end_message = t2.write_to_database(message="END", date=datetime(2018, 5, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        with freeze_time(datetime(2017, 7, 17, 5, 10)):
            ...
            eng_join = t3.write_to_database(message="JOIN Marshall 20-10-2017",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        with freeze_time(datetime(2017, 7, 18, 23, 47, 12)):
            ...
            eng_end_message = t4.write_to_database(message="END",
                                                    date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_assigns_message_sent_at_to_now_hindi(self, texting_mock):
        with freeze_time(datetime(2017, 7, 17, 0, 0)):
            t2 = TextProcessor(phone_number="1-111-2222")
            self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-2222").first()))
            hin_join = t2.write_to_database(message=hindi_remind() + " Aarav 20-10-2017",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
            contact = Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-2222")).first().contact
            self.assertEqual(1, Message.objects.filter(contact=contact).count())
            t2.process(hin_join)
            ...
            hin_born_message = t2.write_to_database(message=hindi_born() + " Aarav 20-10-2017",
                                                    date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
            ...
            hin_end_message = t2.write_to_database(message="END",
                                                    date=datetime(2018, 5, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        with freeze_time(datetime(2017, 7, 17, 5, 10)):
            t3 = TextProcessor(phone_number="1-111-5555")
            self.assertFalse(Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-5555").first()))
            hin_join = t3.write_to_database(message=hindi_remind() + " Marshall 20-10-2017",
                                            date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
            contact = Message.objects.filter(contact=Contact.objects.filter(phone_number="1-111-5555")).first().contact
            self.assertEqual(1, Message.objects.filter(contact=contact).count())
            t3.process(hin_join)
        ...
        with freeze_time(datetime(2017, 7, 18, 23, 47, 12)):
            t4 = TextProcessor(phone_number="1-111-5555")
            hin_end_message = t4.write_to_database(message="END",
                                                    date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
    ...
    def test_processing_assigns_message_sent_at_for_failures(self, texting_mock, logging_error_mock):
        ...
        with freeze_time(datetime(2018, 8, 17, 14, 54, 59)):
            t2 = TextProcessor(phone_number="1-111-1111")
            fail_message = t2.write_to_database(message="Nonsense",
                                                date=datetime(2018, 4, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        with freeze_time(datetime(2017, 7, 18, 23, 47, 12)):
            ...
            hin_join_message = hindi_remind() + " Aarav 25-11-2012"
            hin_join_message = t3.write_to_database(message=hindi_remind() + " Aarav 25-11-2012",
                                                    date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
        ...
        with freeze_time(datetime(2018, 8, 17, 14, 54, 59)):
            ...
            hin_fail_message = t4.write_to_database(message=u"\u0926\u093f\u0928",
                                                    date=datetime(2018, 3, 15, 1, 2, 2).replace(tzinfo=timezone.get_default_timezone()))
